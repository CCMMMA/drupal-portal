...
*/
        ...
        //URL delle api
        //url_api = 'https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpandmbXliNDBjZWd2M2x6bDk3c2ZtOTkifQ._QA7i5Mpkd_m30IGElHziw';
            ...
            onEachFeature: function (feature, layer) {
                if (feature.properties) {
                    ...
                    var popupString = "<div class='popup'>" +
                        ...
                        "<td class='tg-j0tj'>" + clouds / 100 + "%</td>" +
                        "</tr>" +
                        "<tr>" +
